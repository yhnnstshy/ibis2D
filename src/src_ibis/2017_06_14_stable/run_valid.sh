time python ./ibis2d.py --coords ../COORDS_VALID --images ../IMAGES_VALID --outdir ../analysis_2017_06_09 --nfft 256 --recalculate n --thumbnails y

#python ./ibis2d.py --coords ../COORDS_VALID --images ../IMAGES_VALID --outdir ../analysis_2017_05_22_figs --nfft 256 --plotby name --recalculate n

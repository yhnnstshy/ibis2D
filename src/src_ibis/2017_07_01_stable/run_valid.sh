time python ./ibis2d.py --coords ../COORDS_VALID --outdir ../analysis_2017_07_02 --nfft 256 --recalculate n

time python ./ibis2d.py --coords ../COORDS_106 --outdir ../analysis_106 --nfft 256 --recalculate n --thumbnails n

time python ./ibis2d.py --recalculate n --thermometers n --veenafile Veena_Orig.txt --matchfile Veena_Matches.txt --dic_orig ../IMAGES_Tumor_Day6_DIC_K14_original --outdir ../autoveena_2018_02_15 --coords ../COORDS_VALID --nfft 256

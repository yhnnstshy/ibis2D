time python ./ibis2d.py --invasionfile invasion_table.txt --k14file k14_table.txt --dic_orig ../IMAGES_Tumor_Day6_DIC_K14_original --outdir ../autoveena_2017_10_23 --coords ../COORDS_VALID --nfft 256

# time python ./ibis2d.py --coords ../COORDS_106 --images ../IMAGES_VALID --outdir ../analysis_106 --nfft 256 --recalculate n --thumbnails n

time python ./ibis2d.py --coords ../COORDS_VALID --images ../IMAGES_VALID --outdir ../analysis_2017_07_02 --nfft 256 --recalculate n

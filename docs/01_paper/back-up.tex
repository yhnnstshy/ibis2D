...
\begin{flushleft}
{\Large
\textbf\newline{Morphological Features of Organoid Invasion are Correlated with Membrane-Localized Keratin-14 Expression} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
...
\bibitem{Siegel:2017cs}
Siegel, Rebecca L., Kimberly D. Miller, and Ahmedin Jemal. 
\newblock {"Cancer statistics, 2017."}
\newblock {CA: a cancer journal for clinicians 67.1 (2017): 7-30.}

\bibitem{DeSantis:2017BC}
DeSantis, Carol E., et al.
\newblock {"Breast cancer statistics, 2017, racial disparity in mortality by state."}
\newblock{CA: a cancer journal for clinicians 67.6 (2017): 439-448.}

\bibitem{Elkin:2005cts}
Elkin, Elena B., et al. 
\newblock {"The effect of changes in tumor size on breast carcinoma survival in the US: 1975–1999."}
\newblock {Cancer: Interdisciplinary International Journal of the American Cancer Society 104.6 (2005): 1149-1157.}

\bibitem{Park:2015ibc}
Park, Ju-Hyun, William F. Anderson, and Mitchell H. Gail. 
\newblock {"Improvements in US breast cancer survival and proportion explained by tumor size and estrogen-receptor status."}
\newblock {Journal of Clinical Oncology 33.26 (2015): 2870.}

\bibitem {Shamir:2014td}
Shamir, Eliah R., and Andrew J. Ewald.
\newblock {"Three-dimensional organotypic culture: experimental models of mammalian biology and disease."}
\newblock {Nature reviews Molecular cell biology 15.10 (2014): 647.}

\bibitem {Maroulakou:1994pm}
Maroulakou, Ioanna G., et al. 
\newblock{"Prostate and mammary adenocarcinoma in transgenic mice carrying a rat C3 (1) simian virus 40 large tumor antigen fusion gene."} \newblock {Proceedings of the National Academy of Sciences 91.23 (1994): 11236-11240.}

\bibitem {Guy:1992im}
Guy, Chantale T., R. D. Cardiff, and William J. Muller. 
\newblock {"Induction of mammary tumors by expression of polyomavirus middle T oncogene: a transgenic mouse model for metastatic disease."} \newblock {Molecular and cellular biology 12.3 (1992): 954-961.}

\bibitem {Cheung:2013ci}
Cheung, Kevin J., et al. 
\newblock {"Collective invasion in breast cancer requires a conserved basal epithelial program."}
\newblock {Cell 155.7 (2013): 1639-1651.}

\bibitem {Cheung:2016pcb}
Cheung, Kevin J., et al.
\newblock{"Polyclonal breast cancer metastases arise from collective dissemination of keratin 14-expressing tumor cell clusters."}
\newblock {Proceedings of the National Academy of Sciences 113.7 (2016): E854-E863.}


\bibitem{Gusterson:2005bc}
Gusterson, Barry A., et al. 
\newblock {"Basal cytokeratins and their relationship to the cellular origin and functional classification of breast cancer."}
\newblock {Breast Cancer Research 7.4 (2005): 143.}

\bibitem{Laakso:2006blc}
Laakso, Mervi, et al. 
\newblock {"Basoluminal carcinoma: a new biologically and prognostically distinct entity between basal and luminal breast cancer."} \newblock {Clinical Cancer Research 12.14 (2006): 4185-4191.}
